...
namespace HydroLink.Migrations
{
    ...
    [Migration("20250811180431_UpdateComentarioToUseProductoHydroLink")]
    partial class UpdateComentarioToUseProductoHydroLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HydroLink.Models.Comentario", b =>
                {
                    ...
                    b.HasIndex("ProductoHydroLinkId", "UsuarioId")
                        .IsUnique();
            ...
            modelBuilder.Entity("HydroLink.Models.ProductoComprado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HydroLink.Models.ProductoHydroLink", b =>
                {
                    ...
                    b.Property<string>("ManualUsuarioPdf")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HydroLink.Models.Comentario", b =>
                {
                    ...
                    b.HasOne("HydroLink.Models.Producto", null)
                        .WithMany("Comentarios")
                        .HasForeignKey("ProductoId");

                    b.HasOne("HydroLink.AppUser", "Usuario")
                        .WithMany()
